# spark-submit --packages org.apache.spark:spark-sql-kafka-0-10_2.12:3.1.1 6_tumbling_window_app.py
import sys
...
if __name__ == "__main__":
    ...
    grouped = parsed.where("id != 'a' and id != 'b'")\
        ...
        .groupBy(f.window("event_time", "10 seconds", "10 seconds"), "id").count()

    query = (
        grouped.writeStream.outputMode("update")
        .format("console")
